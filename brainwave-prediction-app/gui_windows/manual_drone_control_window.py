...
def manual_drone_control_window(items, get_drone_action, window1):
    ...
    top_center = [
        [sg.Button('Up', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/up.png")]]
    top_right = [[sg.Text('Flight Log')], [sg.Listbox(
        values=[], size=(30, 6), key='LOG')]]
    bottom_center = [
        [sg.Button('Down', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/down.png")]]

    manual_drone_control_layout = [
        [sg.Button('Home', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/home.png"), sg.Push(),
         sg.Column(top_center, pad=((55, 0), (0, 0))), sg.Push(), sg.Column(top_right), ],
        [sg.Push(), sg.Push(), sg.Button('Forward', size=(8, 2),
                                         image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/forward.png"), sg.Push(), sg.Push(),],

        [sg.Button('Turn Left', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/turnLeft.png"),
         sg.Button('Left', size=(8, 2),
                   image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/left.png"),
         sg.Button(
             'Stream', image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/drone.png"),
         sg.Button('Right', size=(8, 2),
                   image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/right.png"),
         sg.Button('Turn Right', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/turnRight.png")],

        [sg.Button('Back', size=(8, 2),
                   image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/back.png")],
        [sg.Button('Connect', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/connect.png"), sg.Push(), sg.Push(), sg.Column(bottom_center, pad=((55, 0), (0, 0))), sg.Push(), sg.Button('Takeoff', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/takeoff.png"), sg.Button('Land', size=(8, 2), image_filename="/Users/ashesh808/Documents/BSCinCS/Fall23/CSCI312/Lab2/Avatar/brainwave-prediction-app/images/land.png")]]
